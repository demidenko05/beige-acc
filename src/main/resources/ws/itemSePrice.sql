...
SELLER.NME as SELLERNME, SELLER.IID as SELLERIID, ITM.IID as ITMIID, ITMPRI.PRICT as PRICT, ITMPRI.PRI, ITMPRI.UNST
from :TITMPRI as ITMPRI 
join :TITM as ITM on ITMPRI.ITM=ITM.IID
left join TXCT on TXCT.IID=ITM.TXCT
left join DBCR as SELLER on ITM.SELLER=SELLER.IID
