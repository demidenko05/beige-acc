select ITSPEC.ITSVERSION as ITSVERSION, ITSPEC.LONGVALUE2 as LONGVALUE2, ITM.IID as ITMIID, ITSPEC.LONGVALUE1 as LONGVALUE1,
...
left join ITMSPF as SPECIFICS on ITSPEC.SPEC=SPECIFICS.IID
...
left join (select NME, HASNM from I18CHOOSEABLESPECIFICS where LNG=':LNG') as I18CHOOSEABLESPECIFICS on I18CHOOSEABLESPECIFICS.HASNM=ITSPEC.LONGVALUE1 and SPECIFICS.TYP=9
left join (select NME, HASNM from I18UOM where LNG=':LNG') as I18UOM on I18UOM.HASNM=ITSPEC.LONGVALUE2 and (SPECIFICS.TYP=1 or SPECIFICS.TYP=2)
